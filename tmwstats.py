...
def makeGraph(size, hours, title):
	...
	plt.xticks([times[0], times[length//4], times[length//2], times[length//4*3], times[-1]], [timeLabels[0], timeLabels[length//4], timeLabels[length//2], timeLabels[length//4*3], timeLabels[-1]], fontproperties = prop)
